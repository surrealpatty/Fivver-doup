...
var Service = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: 'services' })];
    ...
    var Service = _classThis = /** @class */ (function (_super) {
        ...
        function Service_1() {
            ...
            _this.userId = (__runInitializers(_this, _price_extraInitializers), __runInitializers(_this, _userId_initializers, void 0));
            __runInitializers(_this, _userId_extraInitializers);
            return _this;
        }
        return Service_1;
    }(_classSuper));
    ...
    (function () {
        ...
        _price_decorators = [(0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.FLOAT)];
        _userId_decorators = [(0, sequelize_typescript_1.ForeignKey)(function () { return user_1.User; }), (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.INTEGER)];
