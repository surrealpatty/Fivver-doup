...
let Service = (() => {
    let _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: 'services' })];
    ...
    (() => {
        ...
        _price_decorators = [(0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.FLOAT, allowNull: false })];
