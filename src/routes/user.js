...
var bcryptjs_1 = require("bcryptjs"); // bcryptjs for compatibility
var user_1 = require("../models/user"); // Corrected import for User model
var express_validator_1 = require("express-validator");
var router = (0, express_1.Router)();
// User registration route
router.post('/register', 
// Validation middleware
(0, express_validator_1.body)('username').isString().notEmpty().withMessage('Username is required'), (0, express_validator_1.body)('email').isEmail().withMessage('Invalid email format'), (0, express_validator_1.body)('password').isLength({ min: 6 }).withMessage('Password must be at least 6 characters'), (0, express_validator_1.body)('firstName').isString().notEmpty().withMessage('First name is required'), (0, express_validator_1.body)('lastName').isString().notEmpty().withMessage('Last name is required'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, _a, username, email, password, firstName, lastName, existingUser, existingEmail, hashedPassword, user, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                if (existingEmail) {
                    return [2 /*return*/, res.status(400).json({ message: 'Email is already taken' })];
                }
            ...
            case 6:
                error_1 = _b.sent();
                console.error('Error during registration:', error_1.message);
