...
import Review from '../models/review'; // Ensure the import path is correct
import authMiddleware from '../middlewares/authMiddleware'; // Ensure correct import path for authMiddleware
const router = Router();
// 1. Create a new review
router.post('/', authMiddleware, // Protect the route
[
    // Validate input data
...
// 3. Update a review
router.put('/:id', authMiddleware, // Protect the route
[
