...
var user_1 = require("@models/user"); // Correct alias for User model
var services_1 = __importDefault(require("@models/services")); // Correct alias for Service model
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                if (!user) {
                    res.status(404).json({
                        message: "User with ID ".concat(userId, " not found."),
                        error: 'NotFoundError',
                    });
                    return [2 /*return*/];
                }
            ...
            case 3:
                ...
                res.status(500).json({
                    ...
                    error: error_1 instanceof Error ? error_1.message : 'UnknownError',
                });
                return [3 /*break*/, 4];
