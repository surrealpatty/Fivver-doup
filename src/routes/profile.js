...
var user_1 = require("../models/user"); // Correct import for User model
        ...
        switch (_b.label) {
            case 0:
                ...
                if (!userId) {
                    ...
                    return [2 /*return*/]; // End function early if the user ID is invalid
                }
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
            ...
            case 2:
                ...
                if (!userProfile) {
                    ...
                    return [2 /*return*/]; // End function early if the profile is not found
                }
                // Return profile data
                res.status(200).json({
