...
var index_1 = __importDefault(require("../index")); // Import the app instance
...
describe('Role-based Access', function () {
    var paidToken = generateToken('1', 'Paid'); // Generate token for paid user
    var freeToken = generateToken('2', 'Free'); // Generate token for free user
    // Test case for allowing paid users to access premium services
    it('should allow paid users to access premium services', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.default)
                        .get('/services/premium')
                        .set('Authorization', "Bearer ".concat(paidToken))];
                case 1:
                    response = _a.sent();
    ...
    it('should deny free users from accessing premium services', function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, supertest_1.default)(index_1.default)
                        .get('/services/premium')
                        .set('Authorization', "Bearer ".concat(freeToken))];
                case 1:
                    response = _a.sent();
