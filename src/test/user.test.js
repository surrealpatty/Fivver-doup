...
var database_1 = require("../config/database"); // Import your sequelize instance
var user_1 = require("../models/user"); // Import the User model
    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent(); // Ensure the Sequelize connection is authenticated
                    return [2 /*return*/];
            }
        });
    }); });
