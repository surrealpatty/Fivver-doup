...
jest.mock('jsonwebtoken', function () { return ({
    verify: jest.fn(),
    sign: jest.fn(function () { return 'mockedToken'; }), // Return a constant mocked token
}); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require('../config/database')); }).then(function (module) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, module.sequelize.close()];
                                case 1:
                                    _a.sent(); // Close the mocked DB connection
                                    return [2 /*return*/];
                            }
                        });
                    }); })];
