...
const user_1 = __importDefault(require("../models/user")); // Adjusted to use default import
// Get User Profile
const getProfile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.user; // Assuming user ID is stored in the JWT payload as JwtPayload
