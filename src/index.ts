...
import { sequelize } from './config/database'; // Import sequelize from the correct path
import { userRouter } from './routes/user'; // Ensure the correct import of userRouter
