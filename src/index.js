...
var database_1 = require("./config/database"); // Database configuration
...
var startServer = function () { return __awaiter(void 0, void 0, void 0, function () {
    var isDevelopment, syncOptions, PORT_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                syncOptions = isDevelopment ? { alter: true } : {};
                return [4 /*yield*/, database_1.sequelize.sync(syncOptions)];
            case 2:
                _a.sent();
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Error starting the server:', error_1 instanceof Error ? error_1.message : 'Unknown error');
