...
const user_1 = __importDefault(require("./user")); // Import the User model to set up foreign key relationship
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => user_1.default) // Foreign key to User model
    ,
