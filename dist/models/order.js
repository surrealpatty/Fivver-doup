...
var Order = function () {
    var _classDecorators = [(0, sequelize_typescript_1.Table)({ tableName: 'orders', timestamps: false })];
    ...
    var Order = _classThis = /** @class */ (function (_super) {
        ...
        function Order_1() {
            ...
            _this.userId = __runInitializers(_this, _userId_initializers, void 0); // Foreign key to the user who made the order
            _this.serviceId = (__runInitializers(_this, _userId_extraInitializers), __runInitializers(_this, _serviceId_initializers, void 0)); // Foreign key to the service ordered
            _this.orderDetails = (__runInitializers(_this, _serviceId_extraInitializers), __runInitializers(_this, _orderDetails_initializers, void 0)); // Details of the order
            _this.status = (__runInitializers(_this, _orderDetails_extraInitializers), __runInitializers(_this, _status_initializers, void 0)); // Status of the order (e.g., pending, completed)
