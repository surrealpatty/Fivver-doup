...
let Service = class Service extends sequelize_typescript_1.Model {
    ...
    role; // Define role field with validation and default value
...
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => user_1.default) // Foreign key to User
    ,
...
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_1.default) // Define association to User
    ,
