...
const app = require("../../src/app"); // Corrected import to ensure the Express app is used
...
describe('User Tests', () => {
    ...
    describe('POST /api/users/register', () => {
        it('should register a user successfully', async () => {
            ...
            const response = await (0, supertest_1.default)(app).post('/api/users/register').send({
                email: 'test@example.com',
                username: 'testuser',
