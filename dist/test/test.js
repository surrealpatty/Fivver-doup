...
const app = require("../../index.js").app; // Correct import to bring in 'app' from the transpiled index.js
...
describe('Basic Test Suite', () => {
    ...
    it('should respond with a message from the root endpoint', async () => {
        const response = await (0, supertest_1.default)(app).get('/'); // Root endpoint
