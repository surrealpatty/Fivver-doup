...
const index_1 = __importDefault(require("src/index")); // Adjusted to point to the transpiled 'index.js' file in the 'dist' folder
...
describe('Basic Test Suite', () => {
    ...
    it('should respond with a message from the root endpoint', async () => {
        const response = await (0, supertest_1.default)(index_1.default).get('/'); // Root endpoint
