...
const service_1 = __importDefault(require("../models/service")); // Import Service and ServiceCreationAttributes
...
const testModels = async () => {
    try {
        ...
        const testService = await service_1.default.create(testServiceData);
