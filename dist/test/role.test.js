...
const index_1 = __importDefault(require("../index")); // Ensure correct import for your app
describe('Role-based Access Tests', () => {
    ...
    afterAll(async () => {
        ...
        if (testUser && testUser.id) {
            await (0, supertest_1.default)(index_1.default).delete(`/users/${testUser.id}`); // Example cleanup, adjust as needed
        }
    });
    ...
    it('should allow access to premium service for paid users', async () => {
        ...
        const paidUserResponse = await (0, supertest_1.default)(index_1.default)
