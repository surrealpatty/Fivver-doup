...
const index_1 = require("../index"); // Default import
...
beforeAll(async () => {
    ...
    sequelizeInstance = new sequelize_typescript_1.Sequelize({
        ...
        models: [user_1.default, services_1.Service], // Ensure the models are correctly passed here
    ...
    user_1.default.hasMany(services_1.Service, { foreignKey: 'userId' });
...
describe('Authentication Tests', () => {
    it('should authenticate and return a valid JWT token', async () => {
        ...
        const decoded = jsonwebtoken_1.default.verify(loginResponse.body.token, process.env.JWT_SECRET_KEY || 'your-secret-key');
