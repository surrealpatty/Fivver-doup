...
var services_1 = __importDefault(require("../models/services")); // Import the interface and class
var user_1 = require("../models/user"); // Correct named import for User
var database_1 = require("../config/database"); // Import the sequelize instance
describe('Service Model Tests', function () {
    ...
    it('should create a new service', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, serviceData, service;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_1.User.create({
                        username: 'testUser',
                ...
                case 1:
                    ...
                    return [4 /*yield*/, services_1.default.create(serviceData)];
                case 2:
                    service = _a.sent();
