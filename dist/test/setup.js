...
var database_1 = require("../config/database"); // Ensure this is correctly imported
/**
...
afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                _a.sent(); // Ensure sequelize connection is closed asynchronously
                console.log('Sequelize connection closed.');
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                console.error('Error closing sequelize connection:', error_1);
                return [3 /*break*/, 4];
