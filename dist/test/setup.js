...
require("../models/user"); // Ensure the User model is imported and registered with Sequelize
require("../models/services"); // Import other models as necessary
...
const syncDatabase = async () => {
    try {
        ...
        await database_1.sequelize.sync({ force: true }); // Drop and recreate schema before each test run
