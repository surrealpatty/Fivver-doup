...
const _index = require("../../index.js"); // Corrected path to the transpiled file
...
describe('Service Tests', () => {
    ...
    describe('POST /api/services/create', () => {
        it('should create a service successfully', async () => {
            ...
            const response = await (0, supertest_1.default)(_index.app).post('/api/services/create').send({
                title: 'Test Service',
                description: 'This is a test service',
                price: 100,
            });
