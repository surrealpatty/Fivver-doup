...
const authenticateToken_1 = __importDefault(require("../middlewares/authenticateToken")); // Middleware for token verification
...
router.get('/premium', authenticateToken_1.default, checkRole('Paid'), (req, res) => {
