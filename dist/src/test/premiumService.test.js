...
describe('Premium Service Access', ()=>{
    ...
    it('should allow paid users to access premium services', async ()=>{
        const response = await (0, _supertest.default)(_index.app).get('/users/premium-service') // Ensure this route matches your actual implementation
...
describe('Basic Test Suite', ()=>{
    ...
    it('should respond with a message from the root endpoint', async ()=>{
        const response = await (0, _supertest.default)(_index.app).get('/'); // Root endpoint
