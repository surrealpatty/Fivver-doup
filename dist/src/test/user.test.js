...
describe('User Controller', ()=>{
    ...
    it('should create a new user', async ()=>{
        ...
        const response = await (0, _supertest.default)(_index.default).post('/api/users/signup').send(userPayload);
    ...
    it('should login a user with valid credentials', async ()=>{
        ...
        const response = await (0, _supertest.default)(_index.default).post('/api/users/login').send(loginPayload);
