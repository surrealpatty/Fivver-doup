 ...
 */ _database.default.models.User = _user.default; // Manually add the model to Sequelize's models
/**
 * Sync the database and reset the schema before running tests
 */ const syncDatabase = async ()=>{
    try {
        console.log('Connecting to the database...');
        await _database.default.authenticate(); // Authenticate the connection
...
afterAll(async ()=>{
    ...
    await _database.default.close(); // Close the database connection after tests complete
});
