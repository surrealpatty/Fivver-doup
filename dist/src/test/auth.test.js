...
const index_1 = __importDefault(require("../index")); // Correct import for the app
...
describe('Authentication Tests', () => {
    it('should authenticate and return a valid JWT token', async () => {
        ...
        const response = await (0, supertest_1.default)(index_1.default) // Use supertest to make a request to the app
