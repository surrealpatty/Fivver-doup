...
const database_1 = require("@config/database"); // Correctly use the alias path to resolve config/database
...
const user_2 = require("@models/user"); // Correct alias for models
