...
var registerUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, username, password, existingUser, hashedPassword, user, error_1;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                if (!email || !username || !password) {
                    return [2 /*return*/, res.status(400).json({ message: 'Please provide all fields' })];
                }
            ...
            case 3:
                ...
                return [4 /*yield*/, user_1.User.create({ email: email, username: username, password: hashedPassword })];
            case 4:
                user = _b.sent();
            ...
            case 5:
                ...
                return [2 /*return*/, res.status(500).json({ message: 'Server error during user registration' })];
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                token = jsonwebtoken_1.default.sign({ id: user.id, email: user.email, username: user.username }, process.env.JWT_SECRET || 'your-default-secret', // Use a default secret if not set
            ...
            case 4:
                ...
                return [2 /*return*/, res.status(500).json({ message: 'Server error during login' })];
