...
var services_1 = __importDefault(require("@models/services")); // Ensure correct path to Service model
// Function to update an existing service
var updateService = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, _a, name, description, price, service, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, services_1.default.findByPk(id)];
            case 2:
                service = _b.sent();
                ...
                service.name = name !== null && name !== void 0 ? name : service.name; // Use nullish coalescing to only update if value is not null or undefined
            ...
            case 4:
                ...
                if (error_1 instanceof Error) {
                    res.status(500).json({ message: 'Error updating service', error: error_1.message });
                }
                else {
