...
const { User, initUser } = require('./models/user'); // Ensure you are importing the initUser function
const { Service, initService } = require('./models/services'); // Ensure you are importing the initService function
